...
// registerPrompts wires GET /sessions/{id}/prompts/{role}. Invalid
// roles map to invalid_request before any filesystem call (the
// service does the closed-enum check); unknown sessions and missing
// prompt files map to session_not_found and role_not_found
// respectively.
