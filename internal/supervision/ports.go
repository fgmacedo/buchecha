...
type Planner interface {
	Plan(ctx context.Context, in PlannerInput, events chan<- agentcontract.AgentEvent) (*Plan, *SpawnStats, error)
}
...
type Briefer interface {
	Brief(ctx context.Context, in BrieferInput, events chan<- agentcontract.AgentEvent) (*SpawnStats, error)
}
...
type Reviewer interface {
	Review(ctx context.Context, in ReviewerInput, events chan<- agentcontract.AgentEvent) (*SpawnStats, error)
}
